...
Built an autocomplete system using a trie data structure. Uses data from [AmazonQAC dataset](https://huggingface.co/datasets/amazon/AmazonQAC) - like 350M real Amazon searches. Pretty fast (microsecs to search and 0.193secs to index) and works well.
